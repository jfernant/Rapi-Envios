            ...
            <table class="table align-middle mb-0">
                ...
                <?php foreach ($resultado as $fila ) {?>
                    <tr>
                        ...
                        <td><span class="badge rounded-pill bg-primary p-2"><?php echo escape($fila['estado']); ?></span></td>
                        <td>
                            <div class="d-flex justify-content-start">
                        <?php if($fila['id']){?> 
                            <?php if($fila['estado'] == 'Prealertado') {?> 
                                <a href="./actualizar_paquete.php?id=<?php echo encrypt($fila['id']);?>" class="btn btn-sm btn-success mx-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar prealerta"><span class="material-icons">edit</span></a>
                                <a href="./confirmar.php?id=<?php echo encrypt($fila['id']);?>" class="btn btn-sm btn-danger mx-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Cancelar prealerta"><span class="material-icons">close</span></a>
                            <?php } 
                            }
                        ?>
                            </div>
